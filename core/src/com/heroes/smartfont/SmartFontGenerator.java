...
import com.heroes.smartfont.writer.BitmapFontWriter;*/
...
public class SmartFontGenerator {
    ...
    *//** Will load font from file. If that fails, font will be generated and saved to file.
    ...
    public BitmapFont createFont(FileHandle fontFile, String fontName, int fontSize) {
        ...
        //} else {
            try {
                ...
                font = loadFontFile(fontName, fontSize);
                loaded = true;
    ...
    public BitmapFont generateFontWriteFiles(String fontName, int fontSize) {
        return generateFontWriteFiles("ttf/" + fontName + ".ttf", fontName, fontSize);
    }

    public BitmapFont generateFontWriteFiles(String fontFilename, String fontName, int fontSize) {
        return generateFontWriteFiles(fontName, Gdx.files.internal(fontFilename), fontSize, pageSize, pageSize);
    }

    public BitmapFont generateFontWriteFiles(FileHandle fontFile, String fontName, int fontSize) {
        return generateFontWriteFiles(fontName, fontFile, fontSize, pageSize, pageSize);
    }
    ...
    *//** Convenience method for generating a font, and then writing the fnt and png files.
    ...
    public BitmapFont loadFontFile(String fontName, int fontSize) {
        return new BitmapFont(getFontFile(fontName + ".fnt", fontSize));
    }
